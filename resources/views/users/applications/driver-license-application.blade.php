...
@section('title', 'Manage driver license application')
@section('content')


    <section class="section">
        <div class="section-header">
            <h1 class="text-center font-weight-bold"> Manage driver license application</h1>
        </div>
        <div class="container">
                            ...
                            <tbody>
                                ...
                                @forelse ($applications as $application)
                                 <tr>
                                    ...
                                    <td>
                                        <h6>{{  ucwords($application->licenseconfig->name) }}</h6>
                                    ...
                                    <td>
                                        ...
                                        <p><span class="fa">&#8358; </span>{{ number_format(json_decode($application->payment, true)['price'],2,".",",")}}</p>
                                    </td>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <a href="#process_application" data-toggle="modal" editurl="{{ route('driver-lincense-process.update', $application->id) }}" name="{{ ucwords($application->name) }}" class="badge badge-pill badge-primary mx-1"><span
